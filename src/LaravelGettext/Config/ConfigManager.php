...
namespace Unikat\LaravelGettext\Config;

use \Unikat\LaravelGettext\Config\Models\Config as ConfigModel;
use \Unikat\LaravelGettext\Exceptions\RequiredConfigurationFileException;
use \Unikat\LaravelGettext\Exceptions\RequiredConfigurationKeyException;
...
class ConfigManager
{
    ...
    protected function generateFromArray(array $config)
    {
        ...
        $adapter = isset($config['adapter']) ? $config['adapter'] : \Unikat\LaravelGettext\Adapters\LaravelAdapter::class;
