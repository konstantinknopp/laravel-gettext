...
namespace Unikat\LaravelGettext\Translators;

use Unikat\LaravelGettext\FileSystem;
use Unikat\LaravelGettext\Adapters\AdapterInterface;
use Unikat\LaravelGettext\Config\Models\Config;
use Unikat\LaravelGettext\Exceptions\LocaleNotSupportedException;
use Unikat\LaravelGettext\Exceptions\MissingPhpGettextModuleException;
use Unikat\LaravelGettext\Exceptions\UndefinedDomainException;

use Illuminate\Support\Facades\Session;

/**
 * Class implemented by the php-gettext module translator
 * @package Unikat\LaravelGettext\Translators
 */
class Gettext extends BaseTranslator implements TranslatorInterface
{
    /**
     * Config container
     * @type \Unikat\LaravelGettext\Config\Models\Config
     */
    ...
    /**
     * Framework adapter
     * @type \Unikat\LaravelGettext\Adapters\LaravelAdapter
     */
    protected $adapter;
     ...
     *
     * @throws \Unikat\LaravelGettext\Exceptions\LocaleNotSupportedException
     * @throws \Unikat\LaravelGettext\Exceptions\MissingPhpGettextModuleException
     * @throws \Exception
     */
